...
def process_data():
    try:
        ...
        for i, cv_text in enumerate(cv_texts):
            # Limiter la longueur du texte pour éviter des entrées trop longues
            cv_text = cv_text[:1000]
            job_text = job_texts[0][:1000]
...
def display_report(report):
    ...
    for entry in report:
        ...
        report_text.insert(tk.END, "Analyse de l'offre d'emploi: {}\n".format(entry["Analyse de l'offre d'emploi"]))
